...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-12318392.733829, 7135795.138922, -12256638.410181, 7173585.098169], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-12318392.733829, 7135795.138922, -12256638.410181, 7173585.098169], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">AMP - FROG LAKE FIRST NATION</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (394 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The Frog Lake First Nation Asset Management Webmap serves as a pivotal tool for the effective administration of community resources. This interactive map amalgamates asset data from three essential sources: detailed field surveys, insightful community data contributions, and open-source data. It provides a comprehensive overview of infrastructure including buildings, roadways, driveways etc.';
            }
